...
void question(string q, string answer1, string answer2, int qNum);
...
int main(){
    ...
    // Function Calls
    question("Who invented the first computer", "Alan Turing", "Turing", 1);
    question("What does the fox say", "Nobody knows", "", 2); // Blank space is an answer here as well
    question("Who founded Facebook (first and last name)", "Mark Zuckerburg", "Mark Zuckerburg", 3); // Only one correct answer
